...
if __name__ == '__main__':
    ...
    #box_pose.header.frame_id = robot.get_planning_frame() "panda_hand"
    ...
    timeout=4
    rospy.loginfo("actualiza escena ?")
    wait_for_state_update(box_is_known=True, timeout=timeout)
    rospy.loginfo("FIN ESCENA")
